      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          >
            ...
            <div
              className={`flex flex-col border-l pl-2.5 transition-colors duration-200 ${scrolled ? "border-white/25" : "border-slate-300/80"
                }`}
            >
              ...
              <span
                className={`text-[10px] sm:text-[11px] font-extrabold leading-tight ${scrolled ? "text-white" : "text-slate-900"
                  }`}
              >
                Platform Ujian OSCE
              </span>
            ...
            {!user ? (
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center gap-2.5 rounded-full border px-4 py-2 transition cursor-pointer shadow-xs ${scrolled
                ...
                >
                  ...
                  <span
                    className={`text-xs font-bold truncate max-w-[120px] ${scrolled ? "text-white" : "text-[#0D3A68]"
                      }`}
                  >
                    {displayName}
                  </span>
                  <ChevronDown
                    size={14}
                    className={`transition-transform duration-200 ${scrolled ? "text-amber-200" : "text-slate-500"
          ...
          <div className="flex lg:hidden items-center">
            <button
              ...
              className={`flex h-10 w-10 items-center justify-center rounded-2xl transition duration-200 cursor-pointer shadow-xs ${scrolled
                ...
                {items.map((item, idx) => {
                  ...
                  return (
                    <button
                      key={idx}
                      onClick={() => scrollToSection(item.href)}
                      className={`text-left py-2.5 px-3.5 rounded-xl transition flex items-center justify-between cursor-pointer ${isActive
