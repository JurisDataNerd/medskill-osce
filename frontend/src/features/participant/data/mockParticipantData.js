...
export const MY_PAST_RESULTS = [
  {
    ...
    feedback: "Pemeriksaan fungsi nervus kranial dikerjakan secara sangat sistematis, terstruktur, dan memperhatikan aspek higienis serta kenyamanan pasien.",
    rubric_breakdown: [
      { question: "Menyapa salam & konfirmasi identitas pasien", points: 1, max: 1 },
      { question: "Anamnesis terarah kelemahan otot wajah", points: 3, max: 3 },
      { question: "Inspeksi & palpasi simetrisitas otot wajah (N. VII)", points: 2.75, max: 3 },
      { question: "Pemeriksaan fungsi motorik lidah (N. XII)", points: 2.5, max: 3 },
    ],
  },
  {
    id: "res-002",
    ...
    station_name: "Stase 1: Resusitasi Jantung Paru (RJP)",
    case_title: "Penanganan Henti Jantung (Cardiac Arrest) & Defibrilasi",
